 ...
 */
final class Version20250109040210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE doctor ADD speciality_id INT NOT NULL, DROP speciality');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE doctor ADD speciality VARCHAR(255) NOT NULL, DROP speciality_id');
    }
}
