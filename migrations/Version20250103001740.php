 ...
 */
final class Version20250103001740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment ADD doctor_id INT NOT NULL, ADD patient_id INT DEFAULT NULL, ADD date DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE patient ADD first_name VARCHAR(255) NOT NULL, ADD last_name VARCHAR(255) NOT NULL, ADD birth_date DATE NOT NULL, ADD email VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient DROP first_name, DROP last_name, DROP birth_date, DROP email');
    }
}
