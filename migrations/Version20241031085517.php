 ...
 */
final class Version20241031085517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD categorie_id INT DEFAULT NULL, CHANGE prix prix NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP categorie_id, CHANGE prix prix NUMERIC(10, 2) DEFAULT NULL');
    }
}
