 ...
 */
final class Version20250103003615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment ADD patient_id INT NOT NULL, ADD date DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment DROP patient_id, DROP date');
    }
}
